...
const postTagsCache = new Cache();
const postCategoriesCache = new Cache();
...
module.exports = ctx => {
  ...
  Post.virtual('tags').get(function() {
    return postTagsCache.apply(this._id, () => {
  ...
  Post.virtual('categories').get(function() {
    return postCategoriesCache.apply(this._id, () => {
