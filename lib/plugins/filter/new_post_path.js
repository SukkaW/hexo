  ...
  if (path) {
    ...
    switch (layout) {
      ...
      default: {
        ...
        filenameData.month = filenameData.i_month < 10 ? `0${filenameData.i_month}` : filenameData.i_month;
        filenameData.day = filenameData.i_day < 10 ? `0${filenameData.i_day}` : filenameData.i_day;
