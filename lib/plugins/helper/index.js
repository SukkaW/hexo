...
module.exports = ctx => {
  ...
  helper.register('strip_html', strip_html, false);
  helper.register('trim', trim, false);
  helper.register('titlecase', titlecase, false);
  helper.register('word_wrap', word_wrap, false);
  helper.register('truncate', truncate, false);

  helper.register('fragment_cache', require('./fragment_cache')(ctx));

  helper.register('gravatar', require('./gravatar'), false);
  ...
  helper.register('number_format', require('./number_format'), false);
  ...
  helper.register('toc', require('./toc'), false);

  helper.register('relative_url', require('./relative_url'), false);
  helper.register('url_for', require('./url_for'));
  helper.register('full_url_for', require('./full_url_for'));

  const debug = require('./debug');
  helper.register('inspect', debug.inspectObject, false);
  helper.register('log', debug.log, false);
};
